...
if gaud_sty.savefig:
    if gaud_sty.color:
        plt.savefig(gaud_sty.save_dir+'ch03_line_fitting_1_col.png')
    else:
        plt.savefig(gaud_sty.save_dir+'ch03_line_fitting_1.png')
plt.show()
...
if gaud_sty.savefig:
    if gaud_sty.color:
        plt.savefig(gaud_sty.save_dir+'ch03_line_fitting_2_col.png')
    else:
        plt.savefig(gaud_sty.save_dir+'ch03_line_fitting_2.png')
plt.show()
...
if gaud_sty.savefig:
    if gaud_sty.color:
        plt.savefig(gaud_sty.save_dir+'ch03_line_fitting_3_col.png')
    else:
        plt.savefig(gaud_sty.save_dir+'ch03_line_fitting_3.png')
plt.show()
...
if gaud_sty.savefig:
    if gaud_sty.color:
        plt.savefig(gaud_sty.save_dir+'ch03_line_fitting_4_col.png')
    else:
        plt.savefig(gaud_sty.save_dir+'ch03_line_fitting_4.png')
plt.show()
...
if gaud_sty.savefig:
    if gaud_sty.color:
        plt.savefig(gaud_sty.save_dir+'ch03_line_fitting_5.png')
    else:
        plt.savefig(gaud_sty.save_dir+'ch03_line_fitting_5.png')
plt.show()
